...
class mlpcn: 
    ...
    def mlptrain_automatic(self,train,traint,valid,validt,itSteps):
        ...
        while n < 2 or (validerror[n] < validerror[n-1]):
            n+=1
            trainerror = np.append(trainerror,self.errfunc(self.mlpfwd(train,True)[1],traint))
