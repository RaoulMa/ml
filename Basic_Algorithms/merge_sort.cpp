...
void mergeSort(int arr[], int l, int r){
    /* Args: l is for left index and r is right index of the
    ...
    if (l < r){
        ...
        merge(arr, l, m, r);    // merge left and right half
    }
}
...
int main(){
    /* Main program for the MergeSort Algorithm */
    
    cout << "-- MergeSort Algorithm --\n";
